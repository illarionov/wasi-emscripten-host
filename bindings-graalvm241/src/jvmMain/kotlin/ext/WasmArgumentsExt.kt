...
internal inline fun Array<Any>.getArgAsByte(idx: Int): Byte = (WasmArguments.getArgument(this, idx) as Int).toByte()
internal inline fun Array<Any>.getArgAsShort(idx: Int): Short = (WasmArguments.getArgument(this, idx) as Int).toShort()
