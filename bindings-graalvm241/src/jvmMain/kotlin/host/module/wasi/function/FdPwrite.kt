...
internal class FdPwrite(
    ...
    module: WasmModule,
    host: EmbedderHost,
) : BaseWasiWasmNode<FdPwriteFunctionHandle>(language, module, FdPwriteFunctionHandle(host)) {
    ...
    private fun fdWrite(
        ...
        return handle.execute(hostMemory, wasiMemoryWriter, fd, pCiov, cIovCnt, offset, pNum).code
    }
}
