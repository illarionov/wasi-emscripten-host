...
internal class FdPread(
    ...
    module: WasmModule,
    host: EmbedderHost,
) : BaseWasiWasmNode<FdPreadFunctionHandle>(language, module, FdPreadFunctionHandle(host)) {
    ...
    private fun fdRead(
        ...
        return handle.execute(hostMemory, wasiMemoryReader, fd, pIov, iovCnt, offset, pNum).code
    }
}
