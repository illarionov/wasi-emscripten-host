...
public class WasmModuleMemoryHelper(
    private val module: WasmModule,
) {
    @InternalWasiEmscriptenHostApi
    public fun setupMemory(
        source: MemorySource,
    ...
    internal fun setImportedMemory(
    ...
    internal fun setExportedMemory(
    ...
    internal fun setExternalExportedMemory(
