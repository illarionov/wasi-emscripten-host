...
import at.released.weh.host.emscripten.EmscriptenHostFunction.ABORT_JS
import at.released.weh.host.emscripten.EmscriptenHostFunction.ASSERT_FAIL
import at.released.weh.host.emscripten.EmscriptenHostFunction.EMSCRIPTEN_ASM_CONST_ASYNC_ON_MAIN_THREAD
import at.released.weh.host.emscripten.EmscriptenHostFunction.EMSCRIPTEN_ASM_CONST_INT
import at.released.weh.host.emscripten.EmscriptenHostFunction.EMSCRIPTEN_CONSOLE_ERROR
import at.released.weh.host.emscripten.EmscriptenHostFunction.EMSCRIPTEN_DATE_NOW
import at.released.weh.host.emscripten.EmscriptenHostFunction.EMSCRIPTEN_GET_NOW
import at.released.weh.host.emscripten.EmscriptenHostFunction.EMSCRIPTEN_GET_NOW_IS_MONOTONIC
import at.released.weh.host.emscripten.EmscriptenHostFunction.EMSCRIPTEN_RESIZE_HEAP
import at.released.weh.host.emscripten.EmscriptenHostFunction.GETENTROPY
import at.released.weh.host.emscripten.EmscriptenHostFunction.HANDLE_STACK_OVERFLOW
import at.released.weh.host.emscripten.EmscriptenHostFunction.LOCALTIME_JS
import at.released.weh.host.emscripten.EmscriptenHostFunction.MMAP_JS
import at.released.weh.host.emscripten.EmscriptenHostFunction.MUNMAP_JS
import at.released.weh.host.emscripten.EmscriptenHostFunction.SYSCALL_CHMOD
import at.released.weh.host.emscripten.EmscriptenHostFunction.SYSCALL_FACCESSAT
import at.released.weh.host.emscripten.EmscriptenHostFunction.SYSCALL_FCHMOD
import at.released.weh.host.emscripten.EmscriptenHostFunction.SYSCALL_FCHOWN32
import at.released.weh.host.emscripten.EmscriptenHostFunction.SYSCALL_FCNTL64
import at.released.weh.host.emscripten.EmscriptenHostFunction.SYSCALL_FDATASYNC
import at.released.weh.host.emscripten.EmscriptenHostFunction.SYSCALL_FSTAT64
import at.released.weh.host.emscripten.EmscriptenHostFunction.SYSCALL_FTRUNCATE64
import at.released.weh.host.emscripten.EmscriptenHostFunction.SYSCALL_GETCWD
import at.released.weh.host.emscripten.EmscriptenHostFunction.SYSCALL_LSTAT64
import at.released.weh.host.emscripten.EmscriptenHostFunction.SYSCALL_MKDIRAT
import at.released.weh.host.emscripten.EmscriptenHostFunction.SYSCALL_OPENAT
import at.released.weh.host.emscripten.EmscriptenHostFunction.SYSCALL_READLINKAT
import at.released.weh.host.emscripten.EmscriptenHostFunction.SYSCALL_RMDIR
import at.released.weh.host.emscripten.EmscriptenHostFunction.SYSCALL_STAT64
import at.released.weh.host.emscripten.EmscriptenHostFunction.SYSCALL_UNLINKAT
import at.released.weh.host.emscripten.EmscriptenHostFunction.SYSCALL_UTIMENSAT
