...
/**
 * Annotation denote that the annotated `long` element represents a logical type
 ...
 *
 * This is similar to the `IntDef` annotation from the `androidx-annotation` package, but with BINARY retention.
...
public annotation class WasiEmscriptenHostIntDef(
