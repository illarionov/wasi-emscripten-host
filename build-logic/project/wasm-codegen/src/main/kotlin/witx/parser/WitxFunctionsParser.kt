...
internal object WitxFunctionsParser {
    fun parse(): List<WasiFunc> {
        val content = CharStreams.fromStream(
            Thread.currentThread().contextClassLoader.getResourceAsStream("witx/wasi_snapshot_preview1.witx"),
        )
