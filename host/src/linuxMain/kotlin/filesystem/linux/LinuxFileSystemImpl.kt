...
internal class LinuxFileSystemImpl(
    ...
    private val operations: Map<FileSystemOperation<*, *, *>, FileSystemOperationHandler<*, *, *>> = mapOf(
        Open to LinuxOpen(fsState, fsState.pathResolver, isRootAccessAllowed),
        ...
        CheckAccess to LinuxCheckAccess(fsState.pathResolver),
        Chmod to LinuxChmod(fsState.pathResolver),
        ChmodFd to LinuxChmodFd(fsState),
        Chown to LinuxChown(fsState.pathResolver),
        ...
        Hardlink to LinuxHardlink(fsState.pathResolver),
        Mkdir to LinuxMkdir(fsState.pathResolver),
        PrestatFd to LinuxPrestatFd(fsState),
        Symlink to LinuxSymlink(fsState.pathResolver),
        ReadFd to LinuxReadFd(fsState),
        ReadDirFd to LinuxReadDirFd(fsState),
        ReadLink to LinuxReadLink(fsState.pathResolver),
        Rename to LinuxRename(fsState.pathResolver),
        SeekFd to LinuxSeekFd(fsState),
        SetFdFlags to LinuxSetFdFlags(fsState),
        SetTimestamp to LinuxSetTimestamp(fsState.pathResolver),
        SetTimestampFd to LinuxSetTimestampFd(fsState),
        Stat to LinuxStat(fsState.pathResolver),
        StatFd to LinuxStatFd(fsState),
        SyncFd to LinuxSync(fsState),
        TruncateFd to LinuxTruncateFd(fsState),
        UnlinkFile to LinuxUnlinkFile(fsState.pathResolver),
        UnlinkDirectory to LinuxUnlinkDirectory(fsState.pathResolver),
